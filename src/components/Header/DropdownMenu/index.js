                        ...
                        <div className={styles.inner}>
                            <div className={styles.row}>
                                <div className={styles.col}>
                                    <Link className={styles.direction} href="/class01" onClick={() => handleClick()}>
                                        <div className={styles.info}>Find a class to achieve your goals 🔥</div>
                                                            ...
                                                            <div className={styles.photo}>
                                                                ...
                                                                <div
                                                                    className={cn(
                                                                        ...
                                                                        {
                                                                            "status-purple": item.category === "purple",
                                                                        },
                                                                        styles.category
                                                                    )}
                                                                >
