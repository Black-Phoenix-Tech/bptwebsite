...
const items = [
    {
        ...
        alt: "user",
        content: "A 7-days training program designed to boost your strength & endurance over the course of a week.",
    },
    {
        title: "Advanced",
        url: "/class02-details",
            ...
            <div className={cn("container", styles.container)}>
                <div className={styles.top}>
                    ...
                    <div className={styles.info}>
                        <strong className={styles.green}>10% Discount</strong> if you’re already using the{" "}
                        ...
                        {items.map((x, index) => (
                            <ScrollParallax className={styles.slide} key={index}>
                                <div className={cn("programs-item", styles.item)}>
                                    ...
                                    <Link className={cn("button-stroke", styles.button)} href={x.url}>
                                        Book a class
                                    </Link>
                                </div>
                            </ScrollParallax>
