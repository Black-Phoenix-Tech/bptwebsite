...
const data = [
    {
        ...
        options: ["true", "true", "true", "false", "true", "true", "false", "false", "false", "false"],
    },
    {
        title: "Premium",
        color: "rgba(140, 128, 248, 1)",
        description: "Fit with everyone",
        price: "20.88",
        note: "per month",
        button: "Get Started",
        options: ["true", "true", "true", "true", "true", "true", "true", "true", "false", "false"],
    },
    {
        ...
        button: "Contact Sale",
        options: ["true", "true", "true", "true", "true", "true", "true", "true", "true", "true"],
    },
];
    ...
    return (
        <div className={cn("section-bg", styles.section)}>
            <div className={cn("container", styles.container)}>
                <div className={cn("stage", styles.stage)}>get stronger with fitness pro</div>
                <h1 className={cn("h1", styles.title)}>Choose a plan that’s right for you</h1>
